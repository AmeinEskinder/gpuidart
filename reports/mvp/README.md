...
| Item | Value |
| --- | --- |
| Source commit | `739bd18e543a6e8fcb3bbef42becebce7426abc2` |
| Source state at packaging | No modified SDK source files |
| ZIP size | 11,485,591 bytes, approximately 10.95 MiB |
| Extracted file size | 30,987,154 bytes, approximately 29.55 MiB, excluding filesystem allocation overhead |
| ZIP SHA-256 | `34e0dbc10f4736ee12951d02f9da6131f197a957897eff5a880e2bc3ef9aadae` |
| Recorded source SHA-256 | `5690703ccaba80f81048f48614fd7bfdc1831a7e3d3098147b3d474b91b1ddb6` |
...
| Check | Result |
| --- | --- |
| Native and Dart | Rust formatting, eight native tests, normal DLL build, Dart analysis with fatal lint information, and three Dart/native integration tests passed. |
...
| Verification failures | Changed package contents and a missing explicit self-test success were rejected. Failed verification replaced stale success reports. |
...
The acceptance report and this handoff are saved in the following documentation commit. No subagents were used and no commits were pushed.
