...
[Clean-machine and manual IME checks](windows-release-checks.md) remain explicit release gates. The [latest prerequisite record](../reports/mvp/prerequisites/README.md) shows Sandbox and Japanese typing waiting for Windows servicing to finish after a restart. Actual IME composition, mixed-monitor DPI movement and clean Windows dependency closure have not been established here. The [reload observation](../reports/mvp/attempt-023eef4/README.md) also remains unlocalized despite subsequent passing checks.
